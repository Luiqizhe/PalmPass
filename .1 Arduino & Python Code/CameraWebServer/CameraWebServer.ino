...
const char* ssid = "RentedFam";
const char* password = "Simon@Melor37";
// const char* ssid = "James's Galaxy A12";
// const char* password = "akgi7965";
// const char* ssid = "Zhe iPhone";
// const char* password = "uaena0516";
